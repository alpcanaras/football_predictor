...
LEAGUE_REGISTRY = {
    ...
    # Second tiers and Scotland — frequent Toto coupon fodder, so worth
    # covering rather than falling back to 1/3 each.
    'british_league2':     {'type': 'rich',   'delimiter': ',', 'display_name': 'English League Two'},
    'scottish_prem':       {'type': 'rich',   'delimiter': ',', 'display_name': 'Scottish Premiership'},
    'scottish_champ':      {'type': 'rich',   'delimiter': ',', 'display_name': 'Scottish Championship'},
    'scottish_l1':         {'type': 'rich',   'delimiter': ',', 'display_name': 'Scottish League One'},
    'scottish_l2':         {'type': 'rich',   'delimiter': ',', 'display_name': 'Scottish League Two'},
    'french_2':            {'type': 'rich',   'delimiter': ',', 'display_name': 'French Ligue 2'},
    'italian_2':           {'type': 'rich',   'delimiter': ',', 'display_name': 'Italian Serie B'},
...
FETCH_SOURCES = {
    ...
    'british_league2':     {'url': 'https://www.football-data.co.uk/mmz4281/{season}/E3.csv',  'target': 'E3-1.csv'},
    'scottish_prem':       {'url': 'https://www.football-data.co.uk/mmz4281/{season}/SC0.csv', 'target': 'SC0-1.csv'},
    'scottish_champ':      {'url': 'https://www.football-data.co.uk/mmz4281/{season}/SC1.csv', 'target': 'SC1-1.csv'},
    'scottish_l1':         {'url': 'https://www.football-data.co.uk/mmz4281/{season}/SC2.csv', 'target': 'SC2-1.csv'},
    'scottish_l2':         {'url': 'https://www.football-data.co.uk/mmz4281/{season}/SC3.csv', 'target': 'SC3-1.csv'},
    'french_2':            {'url': 'https://www.football-data.co.uk/mmz4281/{season}/F2.csv',  'target': 'F2-1.csv'},
    'italian_2':           {'url': 'https://www.football-data.co.uk/mmz4281/{season}/I2.csv',  'target': 'I2-1.csv'},
    ...
    'CH':                  {'url': 'https://www.football-data.co.uk/new/SWZ.csv',     'target': 'SWZ.csv'},
    'DANSK':               {'url': 'https://www.football-data.co.uk/new/DNK.csv',     'target': 'DNK.csv'},
    'chn':                 {'url': 'https://www.football-data.co.uk/new/CHN.csv',     'target': 'CHN.csv'},
    'fin':                 {'url': 'https://www.football-data.co.uk/new/FIN.csv',     'target': 'FIN.csv'},
    'japan':               {'url': 'https://www.football-data.co.uk/new/JPN.csv',     'target': 'JPN.csv'},
    'norsk':               {'url': 'https://www.football-data.co.uk/new/NOR.csv',     'target': 'NOR.csv'},
    ...
    'swedish':             {'url': 'https://www.football-data.co.uk/new/SWE.csv',     'target': 'SWE.csv'},
